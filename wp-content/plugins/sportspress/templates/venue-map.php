...
if ( $latitude != null && $longitude != null ):
    ...
    <iframe
      ...
      src="https://www.google.com/maps/embed/v1/search?key=AIzaSyDFutFLfiJAQ9XFIRR-6NGb2ExY20V9cS0&amp;q=<?php echo $address; ?>&amp;center=<?php echo $latitude; ?>,<?php echo $longitude; ?>&amp;zoom=<?php echo $zoom; ?>&amp;maptype=<?php echo $maptype; ?>" allowfullscreen>
    </iframe>
    <?php
endif;
