...
function rookie_header_area_ole() {
	...
	<div class="header-area header-area-custom">
		<div class="col-md-4 site-branding<?php if ( ! isset( $logo ) && ! display_header_text() ) { ?> site-branding-empty<?php } ?>">
			<?php if ( isset( $logo ) ) { ?>
			<a class="site-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php echo $logo; ?>" alt="<?php bloginfo( 'name' ); ?>"></a>
			<?php } ?>
			<?php if ( display_header_text() ) { ?>
		...
		<!-- -->
			...
			<?php if ( is_active_sidebar( 'header-1' ) ) { ?>
			<div id="tertiary" class="site-widgets col-md-6" role="complementary">
				<div class="site-widget-region">
					<?php dynamic_sidebar( 'header-1' ); ?>
				</div>
			</div>
...
function rookie_paging_nav() {
	...
	<nav class="navigation paging-navigation" role="navigation">
		...
		<div class="nav-links">
			...
			<div class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav">&larr;</span> Articles plus anciens', 'rookie' ) ); ?></div>
			<?php endif; ?>

			<?php if ( get_previous_posts_link() ) : ?>
			<div class="nav-next"><?php previous_posts_link( __( 'Articles plus récents <span class="meta-nav">&rarr;</span>', 'rookie' ) ); ?></div>
			<?php endif; ?>
...
function rookie_entry_date() {
	...
	if ( '' !== $posted_on ) {
		echo '<span class="posted-on"><span class="dashicons dashicons-calendar-alt" style="color: #666;"></span>&nbsp;' . $posted_on . '</span>';
	}
}
endif;
